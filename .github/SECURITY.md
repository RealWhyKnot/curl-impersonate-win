...
https://github.com/RealWhyKnot/curl-impersonate-win/security/advisories/new

I try to acknowledge new reports within 7 days and aim for an initial assessment within 14 days. There is no bug bounty.

## Scope

curl-impersonate-win is a Windows CLI. Reports are in scope when they involve unintended code execution, unsafe file writes, privilege boundary issues, local service exposure, or behavior that lets untrusted input compromise the user's machine or project.
